import { Handshake, Settings, BarChart3, Globe, Share2, GraduationCap } from 'lucide-react';
import type { User, Step, NavigationItem, SPPOption, ProgramTrack, SuccessStory } from '../types';
...
export const SUCCESS_STORIES: SuccessStory[] = [
  {
    id: 'rajesh-kumar',
    name: 'Rajesh Kumar',
    quote: 'From a small town in India to working as a senior developer in Berlin. Sirtifai made my international career possible.',
  ...
  },
  {
    id: 'priya-sharma',
    name: 'Priya Sharma',
    quote: 'As a mother returning to work, the Domestic Freelancer program gave me flexibility and steady income while updating my skills.',
