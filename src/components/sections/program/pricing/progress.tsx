const Progress = () => {
  return (
    <div className="md:w-full mt-4 md:mt-16 mx-auto relative rounded-[21px] flex flex-row justify-center items-center gap-4 md:gap-8">
        ...
        <div className="px-4 md:px-8 py-4 md:py-[34px]">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-8">
            <div>
              ...
              <span className="text-[#FC4C03] font-inter">
                Income: $2,870 - $4,187.
              </span>
            </div>
      ...
      <div className="w-full md:w-[500px] md:h-[680px] bg-white shadow-[0 2px 4px 0 rgba(0, 0, 0, 0.10), 0 4px 6px 0 rgba(0, 0, 0, 0.10)] rounded-[12px]">
        ...
        <div className="px-4 md:px-8 py-4 md:py-[34px]">
          ...
          <div className="flex flex-col md:flex-row items-center gap-2 md:gap-8">
            <div>
              <h1 className="text-[#1F2937] text-[30px] font-bold ">$358</h1>
              <span className="text-[#FC4C03]">Income: $5,383 - $8,378 </span>
            </div>
